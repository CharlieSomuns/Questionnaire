...
class Customer(models.Model):
    ...
    wechat=models.CharField(max_length=64,null=True,blank=True,help_text="微信号")
    web=models.CharField(max_length=64,blank=True,null=True,help_text="网站地址")
    industry=models.CharField(max_length=32,blank=True,null=True,help_text="行业")
...
class UserInfo(models.Model):
    ...
    salary=models.CharField(max_length=32,blank=True,null=True,help_text="收入水平")
...
class Questionnaire(models.Model):
    ...
    title=models.CharField(blank=True,null=True,max_length=64,help_text="标题")
    # 连接到Image对象
    ...
    # 背景图片特殊处理
    background=models.CharField(max_length=64,blank=True,null=True,help_text="背景图")
    # 还未创建标签model
